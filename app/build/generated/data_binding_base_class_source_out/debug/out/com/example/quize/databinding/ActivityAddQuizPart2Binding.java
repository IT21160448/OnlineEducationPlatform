...
public final class ActivityAddQuizPart2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityAddQuizPart2Binding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
  ...
  @NonNull
  public static ActivityAddQuizPart2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddQuizPart2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_quiz_part2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddQuizPart2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddQuizPart2Binding((ConstraintLayout) rootView, button2,
